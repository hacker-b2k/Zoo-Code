...
- **규칙 관리 UI** — 설정의 새 규칙 탭에서 전역 및 작업 공간 Zoo 규칙을 편집기에서 직접 만들고, 삭제하고, 열 수 있습니다
- **완료 변경 사항 검토** — 작업이 완료되면 새 "새 변경 사항 보기" 및 "변경 사항 복원" 버튼으로 마지막 프롬프트의 변경 사항을 검사하고 취소할 수 있습니다
- **완화된 Diff 임계값** — 구성 가능한 유사도 임계값으로 diff 적용 시 "편집 실패" 오류가 줄어들며, 설정 조정을 돕는 새 진단 기능이 추가되었습니다
