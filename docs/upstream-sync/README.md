...
**Canonical branch for all imports:** `integration` (see [BRANCH_AND_UPSTREAM_POLICY.md](../BRANCH_AND_UPSTREAM_POLICY.md)).
**Never re-introduce** Deep Sequential (`src/core/pipeline`) — ADR-005.
