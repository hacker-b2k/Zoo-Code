...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		imageGenerationCustomProvider: undefined,
		vertexImageProjectId: "",
		vertexImageRegion: "us-central1",
		vertexImageModel: "imagen-4.0-generate-001",
		vertexImageAuthMode: "access_token" as VertexImageAuthMode,
